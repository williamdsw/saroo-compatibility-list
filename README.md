...
- [Playlist with Tested Games on YouTube (+ 1070 videos)](https://www.youtube.com/playlist?list=PLmsMlzwbRlgLngxWI9ZzPK44Gix1Ek-ZO)
...
- `Europe` - EUR, EU (41 Games)
- `France` - FRA, FR (0 Games)
- `Germany` - GER, GE (1 Game)
- `Italy` - ITA, IT (0 Game)
- `Japan` - JAP, JP (724 Games)
- `South Korea` - STK, SK (0 Games)
- `Spain` - SPA, SP (0 Games)
- `Taiwan` - TAI, TW (1 Game)
- `USA` - United States of America, US (206 Games)
- Total: 974 games registered
